...
})({"gExD8":[function(require,module,exports) {
...
},{"kaboom":"larQu","@parcel/transformer-js/src/esmodule-helpers.js":"5gFwY"}],"larQu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
a(Fe, "Vec3");
var de = a((i, t, l)=>new Fe(i, t, l), "vec3"), ue = class {
    constructor(t, l, w){
        b(this, "r", 255);
        b(this, "g", 255);
        b(this, "b", 255);
    ...
    static fromHSL(t, l, w) {
        ...
        let U = a((j, X, Y)=>(Y < 0 && (Y += 1), Y > 1 && (Y -= 1), Y < 1 / 6 ? j + (X - j) * 6 * Y : Y < 0.5 ? X : Y < 2 / 3 ? j + (X - j) * (2 / 3 - Y) * 6 : j), "hue2rgb"), p = w < .5 ? w * (1 + l) : w + l - w * l, S = 2 * w - p, A = U(S, p, t + 1 / 3), q = U(S, p, t), V = U(S, p, t - 1 / 3);
...
a(E, "rgb");
var fr = a((i, t, l)=>v.fromHSL(i, t, l), "hsl2rgb"), k = class {
    constructor(t, l, w, U){
        b(this, "x", 0);
        b(this, "y", 0);
        b(this, "w", 1);
...
var no = a((i = {})=>{
    let t = (()=>{
        ...
        var d, h;
        let e1 = t.gl, n = cn(sn, on), r = Ke(new ImageData(new Uint8ClampedArray([
            255,
            255,
            255,
            255
        ...
        e1.bindBuffer(e1.ARRAY_BUFFER, c), e1.vertexAttribPointer(0, 3, e1.FLOAT, !1, je * 4, 0), e1.enableVertexAttribArray(0), e1.vertexAttribPointer(1, 2, e1.FLOAT, !1, je * 4, 12), e1.enableVertexAttribArray(1), e1.vertexAttribPointer(2, 4, e1.FLOAT, !1, je * 4, 20), e1.enableVertexAttribArray(2), e1.bufferData(e1.ARRAY_BUFFER, bt * 4, e1.DYNAMIC_DRAW), e1.bindBuffer(e1.ARRAY_BUFFER, null);
    ...
    let w = (()=>{
        ...
        return e1.decodeAudioData(Mr.buffer.slice(0), (u)=>{
            r.buf = u;
        }, ()=>{
        ...
        gravity: Vr,
        on (e1, n) {
            return this.events[e1] || (this.events[e1] = new $), this.events[e1].pushd(n);
        },
        trigger (e1, ...n) {
    ...
    a(vt, "getShader");
    function ve(e1 = 1, n = 1, r = 0, u = 0, c = 1, s = 1) {
        let o = [], d = c / e1, h = s / n;
        for(let m = 0; m < n; m++)for(let g = 0; g < e1; g++)o.push(new k(r + g * d, u + m * h, d, h));
        return o;
    }
    a(ve, "slice");
    function Ee(e1, n) {
        return S(typeof n == "string" ? V(n).then((r)=>r.json()).then((r)=>Ee(e1, r)) : J(null, e1).then((r)=>{
    ...
    function J(e1, n, r = {
        ...
        return S(new Promise((u, c)=>{
            ...
            typeof n == "string" ? j(n).then((s)=>u(Te(e1, s, r))).catch(c) : u(Te(e1, n, r));
        }));
    }
    a(J, "loadSprite");
    function $e(e1, n) {
    ...
    a(_r, "loadBean");
    function Br(e1) {
        return e1 !== void 0 && (w.masterNode.gain.value = z(e1, Or, Ir)), w.masterNode.gain.value;
    }
    a(Br, "volume");
    function Xe(e1, n = {
        loop: !1,
    ...
    a(Ke, "makeTex");
    function cn(e1 = sn, n = on) {
        let r = t.gl, u, c = gs.replace("{{user}}", e1 != null ? e1 : sn), s = Us.replace("{{user}}", n != null ? n : on), o = r.createShader(r.VERTEX_SHADER), d = r.createShader(r.FRAGMENT_SHADER);
...
`) throw new Error(u);
    ...
    function Tt(e1, n, r, u = l.defTex, c = l.defShader, s = {}) {
        u = u != null ? u : l.defTex, c = c != null ? c : l.defShader, (u !== l.curTex || c !== l.curShader || !jt(l.curUniform, s) || l.vqueue.length + e1.length * je > bt || l.iqueue.length + n.length > bt) && ln();
        for (let o of e1){
        ...
        for (let o1 of n)l.iqueue.push(o1 + l.vqueue.length / je - e1.length);
    ...
    function pe(e1) {
        ...
        let n = e1.width, r = e1.height, c = Ye(e1.origin || Ne).scale(f(n, r).scale(-0.5)), s = e1.quad || new k(0, 0, 1, 1), o = e1.color || E(255, 255, 255), d = (h = e1.opacity) != null ? h : 1;
        re(), I(e1.pos), Je(e1.angle), ne(e1.scale), I(c), Tt([
            {
                pos: de(-n / 2, r / 2, 0),
    ...
    function Yr(e1) {
        ...
        let n = (s = e1.quad) != null ? s : new k(0, 0, 1, 1), r = e1.tex.width * n.w, u = e1.tex.height * n.h, c = f(1);
        if (e1.tiled) {
            let o = Math.ceil((e1.width || r) / r), d = Math.ceil((e1.height || u) / u), m = Ye(e1.origin || Ne).add(f(1, 1)).scale(.5).scale(o * r, d * u);
            for(let g = 0; g < o; g++)for(let y = 0; y < d; y++)pe(D(P({}, e1), {
        ...
        } else e1.width && e1.height ? (c.x = e1.width / r, c.y = e1.height / u) : e1.width ? (c.x = e1.width / r, c.y = c.x) : e1.height && (c.y = e1.height / u, c.x = c.y), pe(D(P({}, e1), {
            scale: c.scale(e1.scale || f(1)),
            tex: e1.tex,
            quad: n,
            width: r,
    ...
    function hn(e1) {
        ...
        Yr(D(P({}, e1), {
            tex: n.tex,
            quad: r.scale(e1.quad || new k(0, 0, 1, 1)),
            uniform: e1.uniform
        }));
    }
    a(hn, "drawSprite");
    function Re(e1, n, r, u, c, s = 1) {
    ...
    function Q(e1) {
        ...
        if (e1.width <= 0 || e1.height <= 0) return;
        let n = e1.width, r = e1.height, c = Ye(e1.origin || Ne).add(1, 1).scale(f(n, r).scale(-0.5)), s = [
            f(0, 0),
            f(n, 0),
            f(n, r),
            f(0, r)
    ...
    function dn(e1) {
        ...
        if (!(n.length < 2)) {
            ...
            } else for(let r1 = 0; r1 < n.length - 1; r1++)We(D(P({}, e1), {
                p1: n[r1],
                p2: n[r1 + 1]
            }));
        }
    ...
    function pn(e1) {
        ...
        e1.radiusX === 0 || e1.radiusY === 0 || Qe(D(P({}, e1), {
            pts: Re(f(0), e1.radiusX, e1.radiusY, (n = e1.start) != null ? n : 0, (r = e1.end) != null ? r : 360, e1.resolution),
            radius: 0
        }));
    }
    a(pn, "drawEllipse");
    function Qe(e1) {
        ...
        let n = e1.pts.length;
        if (!(n < 3)) {
            if (re(), I(e1.pos), ne(e1.scale), Je(e1.angle), I(e1.offset), e1.fill !== !1) {
    ...
    function $r(e1) {
        let n = {}, r = e1.replace(wn, "$1"), u = 0;
        for (let c of e1.matchAll(wn)){
    ...
    function me(e1) {
        ...
        let n = gn((Qn = e1.font) != null ? Qn : i.font, U.fonts, ws);
        if (!n) throw new Error(`Font not found: ${e1.font}`);
        let { charStyleMap: r , text: u  } = $r(e1.text + ""), c = u.split(""), s = n.qw * n.tex.width, o = n.qh * n.tex.height, d = e1.size || o, h = f(d / o).scale(f(e1.scale || 1)), m = h.x * s + ((Zn = e1.letterSpacing) != null ? Zn : 0), g = h.y * o + ((er = e1.lineSpacing) != null ? er : 0), y = 0, x = g, W = 0, O = [], M = [], ee = null, te = 0;
        for(; te < c.length;){
            let oe = c[te];
            oe === `
` ? (x += g, y = 0, ee = null, M.push(oe), O.push(M), M = []) : (e1.width ? y + m > e1.width : !1) && (x += g, y = 0, ee != null && (te -= M.length - ee, oe = c[te], M = M.slice(0, ee)), ee = null, O.push(M), M = []), oe !== `
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
        }
        O.push(M), e1.width && (W = e1.width);
        let Ae = [], Oe = f(e1.pos || 0), _ = Ye(e1.origin || Ne).scale(.5), se = -_.x * m - (_.x + .5) * (W - m), Ie = -_.y * g - (_.y + .5) * (x - g), ut = 0;
            ...
            oe.forEach((ct, ji)=>{
                ...
                if (Gt) {
                    let _t = {
                        ...
                        opacity: e1.opacity,
                        color: (tr = e1.color) != null ? tr : E(255, 255, 255),
                        scale: h,
                        angle: 0,
                        uniform: e1.uniform,
                        fixed: e1.fixed
                    ...
                    if (e1.transform) {
                        let lt = typeof e1.transform == "function" ? e1.transform(ut, ct) : e1.transform;
                        lt && mn(_t, lt);
                    }
                    if (r[ut]) {
                        let { styles: lt1 , localIdx: Xi  } = r[ut];
                        for (let Ki of lt1){
                            let Bt = e1.styles[Ki], nr = typeof Bt == "function" ? Bt(Xi, ct) : Bt;
                            nr && mn(_t, nr);
                        }
                    }
                    Ae.push(_t);
    ...
    a(G, "height"), t.canvas.addEventListener("mousemove", (e1)=>{
        ...
        let n = Pr[e1.key] || e1.key.toLowerCase();
        ls.includes(n) && e1.preventDefault(), n.length === 1 && t.charInputted.push(e1.key), n === "space" && t.charInputted.push(" "), e1.repeat ? (t.isKeyPressedRepeat = !0, t.keyStates[n] = "rpressed") : (t.isKeyPressed = !0, t.keyStates[n] = "pressed");
    ...
    let C = {
        ...
        clearLog: ()=>p.logs = [],
        log: (e1)=>p.logs.unshift(`[${nt().toFixed(2)}].time [${e1}].info`),
        error: (e1)=>p.logs.unshift(`[${nt().toFixed(2)}].time [${e1}].error`),
        curRecording: null,
        get paused () {
            return t.paused;
        },
    ...
    a(En, "make");
    function qe(e1, n, r) {
        return p.objEvents[e1] || (p.objEvents[e1] = new $), p.objEvents[e1].pushd({
            tag: n,
            cb: r
        });
    }
    ...
    function Pe(e1, n) {
        ...
        if (typeof e1 == "string") return qe("update", e1, n);
    }
    a(Pe, "onUpdate");
    function Tn(e1, n) {
        if (typeof e1 == "function" && n === void 0) return p.root.onDraw(e1);
        if (typeof e1 == "string") return qe("draw", e1, n);
    }
    a(Tn, "onDraw");
    function Sn(e1, n, r) {
        let u = qe("collide", e1, (o, d, h)=>d.is(n) && r(o, d, h)), c = qe("collide", n, (o, d, h)=>d.is(e1) && r(d, o, h)), s = Pe(e1, (o)=>{
    ...
    a(Sn, "onCollide");
    function Cn(e1, n) {
        return typeof e1 == "function" ? At(e1) : Pe(e1, (r)=>{
    ...
    function H(e1, n) {
        if (Array.isArray(e1)) {
            ...
            return ()=>r.forEach((u)=>u());
        } else return typeof e1 == "function" ? p.on("input", ()=>Le() && e1()) : p.on("input", ()=>Le(e1) && n());
    }
    a(H, "onKeyPress");
    function Pt(e1, n) {
        if (Array.isArray(e1)) {
            ...
            return ()=>r.forEach((u)=>u());
        } else return typeof e1 == "function" ? p.on("input", ()=>Le() && e1()) : p.on("input", ()=>Wt(e1) && n());
    }
    ...
    function Dt(e1, n) {
        if (Array.isArray(e1)) {
            ...
            return ()=>r.forEach((u)=>u());
        } else return typeof e1 == "function" ? p.on("input", ()=>tt() && e1()) : p.on("input", ()=>tt(e1) && n());
    }
    a(Dt, "onKeyRelease");
    function Mn(e1, n) {
        return typeof e1 == "function" ? p.on("input", ()=>Ze() && e1(K())) : p.on("input", ()=>Ze(e1) && n(K()));
    }
    a(Mn, "onMouseDown");
    function At(e1, n) {
        return typeof e1 == "function" ? p.on("input", ()=>Me() && e1(K())) : p.on("input", ()=>Me(e1) && n(K()));
    }
    a(At, "onMousePress");
    function Ln(e1, n) {
    ...
    a(Ln, "onMouseRelease");
    function qn(e1) {
        return p.on("input", ()=>Rt() && e1(K(), yn()));
    }
    a(qn, "onMouseMove");
    function Pn(e1) {
        return p.on("input", ()=>Kr().forEach((n)=>e1(n)));
    }
    a(Pn, "onCharInput");
    function Dn(e1) {
    ...
    function It(e1 = {}) {
        ...
        return {
            ...
            isOutOfView () {
                var s;
                let u = f((s = e1.offset) != null ? s : 0), c = new ke(f(0, 0).sub(u), f(F(), G()).add(u));
    ...
    function fi(e1 = {}) {
        ...
        return {
            ...
            worldArea () {
                ...
                c *= o.x, s *= o.y;
                let d = Ye(this.origin || Ne), h = ((x = this.pos) != null ? x : f(0)).add(this.area.offset).sub(d.add(1, 1).scale(.5).scale(c, s));
                return {
                    shape: "rect",
                    p1: h,
                    p2: f(h.x + c, h.y + s)
    ...
    function Gn(e1, n) {
        let r = new $;
        return e1 && n && r.pushd(new fe(e1, n)), {
            id: "timer",
            wait (u, c) {
    ...
    function xi(e1 = {}) {
        ...
        return {
            ...
            jumpForce: (s = e1.jumpForce) != null ? s : yi,
            ...
            update () {
                ...
                if (!r) {
                    ...
                    n += Fn() * this.weight * Z(), n = Math.min(n, (m = e1.maxVel) != null ? m : bi);
                }
            },
            curPlatform () {
                return r;
    ...
    function Mi(e1, ...n) {
        ...
        let r = p.on("updateStart", ()=>{
            p.events = {}, p.objEvents = {
                ...
                shake: 0,
                transform: new R
            }, p.layers = {}, p.defLayer = null, p.gravity = Vr, p.scenes[e1](...n), i.debug !== !1 && In(), i.burp && Vn(), r();
        });
    }
    a(Mi, "go");
    function Li(e1, n) {
    ...
    a(Yn, "explode");
    let $n = null, Xn = null;
    J(null, Lr).then((e1)=>$n = e1), J(null, qr).then((e1)=>Xn = e1);
    function ki(e1, n = {}) {
        var o, d;
    ...
    a(Kn, "updateFrame");
    function Gi() {
        let e1 = p.cam, n = L.fromAngle(Ge(0, 360)).scale(e1.shake);
        e1.shake = Ve(e1.shake, 0, 5 * Z()), e1.transform = new R().translate(ot()).scale(e1.scale).rotateZ(e1.angle).translate(e1.pos.scale(-1).add(n)), p.root.draw();
    }
    a(Gi, "drawFrame");
    function _i() {
        let e1 = A();
...
`),
    ...
    a(zn, "drawDebug"), i.debug !== !1 && In(), i.burp && Vn(), window.addEventListener("error", (e1)=>{
        C.error(`Error: ${e1.error.message}`), zr(), Jn(()=>{
            A() === 1 && (He(), zn(), ze());
        });
    });
    function Jn(e1) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5gFwY"}],"5gFwY":[function(require,module,exports) {
...
},{}]},["gExD8","gLLPy"], "gLLPy", "parcelRequire1d88")
